...
#### Step 1.1: Create MarketDataProvider Protocol
...
class MarketDataProvider(Protocol):
    def get_historical_bars_series(self,
                                 instrument: Instrument,
                                 from_dt: datetime,
                                 until_dt: Optional[datetime] = None) -> Sequence[Bar]: ...

    def stream_historical_bars(self,
                             instrument: Instrument,
                             from_dt: datetime,
                             until_dt: Optional[datetime] = None) -> None: ...

    def subscribe_to_live_bars(self,
                             instrument: Instrument,
                             bar_type: BarType) -> None: ...

    def subscribe_to_live_bars_with_history(self,
                                          instrument: Instrument,
                                          bar_type: BarType,
                                          history_period: datetime) -> None: ...

    def unsubscribe_from_live_bars(self,
                                 instrument: Instrument,
                                 bar_type: BarType) -> None: ...
```
