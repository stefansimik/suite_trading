...
class LiveMarketDataProvider(ABC):
    """Abstract base class for live market data providers with built-in subscription management.

    This provider focuses solely on real-time data streaming and subscription management.
    It handles asynchronous, continuous operations for streaming live market data
    that strategies need during live trading.

    The provider automatically manages subscriptions by tracking actual subscriber objects,
    ...
    data streaming operations. For historical data retrieval, use HistoricalMarketDataProvider.
    """

    def __init__(self):
        """Initialize the live market data provider with subscription tracking."""
    ...
    def connect(self) -> None:
        """Establish connection to live market data source.
    ...
    def disconnect(self) -> None:
        """Close connection to live market data source.
    ...
    def is_connected(self) -> bool:
        ...
        Returns:
            bool: True if connected to live market data source, False otherwise.
        """
        ...
    ...
    def _start_publishing_bars(self, bar_type: BarType) -> None:
        ...
        Raises:
            ConnectionError: If not connected to live market data source.
        """
        ...
