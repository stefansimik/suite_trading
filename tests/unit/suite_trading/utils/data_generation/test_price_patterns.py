...
def test_create_bar_series_with_sine_wave():
    ...
    bars = create_bar_series(first_bar=DEFAULT_FIRST_BAR, num_bars=10, price_pattern_func=sine_wave_function)
    ...
    assert bars[0] == DEFAULT_FIRST_BAR
...
def test_create_bar_series_with_zig_zag():
    ...
    bars = create_bar_series(first_bar=DEFAULT_FIRST_BAR, num_bars=20, price_pattern_func=zig_zag_function)
